...
namespace Ragot
{
    ...
    void HelloTriangleApplication::recordCommanBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
    {
    ...
    void HelloTriangleApplication::drawFrame()
    {
        ...
        recordCommanBuffer(commandBuffers[currentFrame], imageIndex);
